...
export function identify(input: Uint8Array): Uint8Array;

export function invert_bytes(input: Uint8Array): Uint8Array;
...
export interface InitOutput {
    ...
    readonly invert_bytes: (a: number, b: number) => [number, number];
